package com.example.department.models.dtos;
...
public class DepartmentGrpcServerDTO extends DepartmentServiceGrpc.DepartmentServiceImplBase {

    private final DepartmentService service;

    @Autowired
    public DepartmentGrpcServerDTO(DepartmentService service) {
